...
type preloadCounts struct {
	...
	RunLease     runLeaseCountPreloader
	Runner       runnerCountPreloader
	TaskRun      taskRunCountPreloader
	TaskTemplate taskTemplateCountPreloader
...
func getPreloadCount() preloadCounts {
	return preloadCounts{
		...
		RunLease:     buildRunLeaseCountPreloader(),
		Runner:       buildRunnerCountPreloader(),
		TaskRun:      buildTaskRunCountPreloader(),
		TaskTemplate: buildTaskTemplateCountPreloader(),
...
type thenLoadCounts[Q orm.Loadable] struct {
	...
	RunLease     runLeaseCountThenLoader[Q]
	Runner       runnerCountThenLoader[Q]
	TaskRun      taskRunCountThenLoader[Q]
	TaskTemplate taskTemplateCountThenLoader[Q]
...
func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		...
		RunLease:     buildRunLeaseCountThenLoader[Q](),
		Runner:       buildRunnerCountThenLoader[Q](),
		TaskRun:      buildTaskRunCountThenLoader[Q](),
		TaskTemplate: buildTaskTemplateCountThenLoader[Q](),
