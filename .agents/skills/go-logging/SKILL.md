---
name: go-logging
description: Design or review Go logging, slog configuration, structured fields, levels, request context, or a migration from log to slog. Use go-error-handling for error propagation decisions.
---
