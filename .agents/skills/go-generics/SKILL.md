---
name: go-generics
description: Decide whether to use Go generics and design generic functions, types, constraints, aliases, or definitions. Use go-interfaces for runtime polymorphism and behavior-focused abstractions.
---
