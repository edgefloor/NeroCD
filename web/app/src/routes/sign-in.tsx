...
import { bootstrapStatusQuery } from "@/api";
...
function SignInRoute() {
  ...
  return <SignIn error={auth.authError} bootstrapRequired={bootstrap.data?.status !== "complete"} onSubmit={async (email, password) => { try { await auth.signIn(email, password); } catch { /* useAuth retains the rendered authError and route stays put */ } }} />;
}
