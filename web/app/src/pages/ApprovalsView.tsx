  ...
  return (
    <div className="grid gap-2 p-3">
      {approvals.map((approval) => {
        ...
        return (
          <div key={approval.id} className="grid gap-2 rounded-lg border border-border bg-card p-3">
      ...
      <Card>
        ...
        <CardContent className="grid gap-2 p-3">
          {snapshot.approvals.map((approval) => (
            <div key={approval.id} className="rounded-lg border border-border bg-card p-3">
