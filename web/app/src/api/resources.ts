...
export function previewRunLogRetention(options?: Pick<RequestOptions, "signal">): Promise<JSONResponse<"/api/v1/run-log-retention/preview", "post", 200>> { return request("/api/v1/run-log-retention/preview", { ...options, method: "POST", body: {} }); }
...
export function listCapabilities(query?: GetQuery<"/api/v1/capabilities">, options?: Pick<RequestOptions, "signal">): Promise<Schema<"CapabilityListResponse">> { return request("/api/v1/capabilities", { ...options, query }); }
...
export function revokeRunnerEnrollment(input: JSONRequest<"/api/v1/runner-enrollments/revoke", "post">, options?: Pick<RequestOptions, "signal">): Promise<JSONResponse<"/api/v1/runner-enrollments/revoke", "post", 200>> { return request("/api/v1/runner-enrollments/revoke", { ...options, method: "POST", body: input }); }
